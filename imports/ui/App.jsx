...
return (
    <div className='body'>
      {isHelpVisible && (
        <div className="help-dialog" ref={helpDialogRef}>
            ...
            <br></br><br></br>If you're still not sure what to tell me, try following some of our suggested examples!
    ...
    <div className='chat-container'>
      <div className='chat-box'>
        ...
        <Input setError={setError} createError={createError} setResult={setResult}/>
      </div>
