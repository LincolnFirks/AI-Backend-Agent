...
"1. `method`: The CRUD operation to perform, chosen from: `create`, `update`, `read`, or `delete`. You will infer this from the user's request.\n" +
...
"   Response: { \"method\": \"create\", \"key\": \"user_name\", \"value\": \"John Doe\" }\n" +
"2. Request: 'I want to delete the user account.'\n" +
"   Response: { \"method\": \"delete\", \"key\": \"user_account\", \"value\": \"\" }\n" +
"3. Request: 'Tell me what the system status is.'\n" +
"   Response: { \"method\": \"read\", \"key\": \"system_status\", \"value\": \"\" }\n" +
"4. Request: 'Can you please update my email to newemail@example.com?'\n" +
"   Response: { \"method\": \"update\", \"key\": \"email\", \"value\": \"newemail@example.com\" }\n" +
...
"   Response: { \"method\": \"update\", \"key\": \"aweofoiejfw121983\", \"value\": \"0293hweo 234wmnvb\" }\n" +
